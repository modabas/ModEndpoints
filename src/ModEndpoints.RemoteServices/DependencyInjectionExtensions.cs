...
public static class DependencyInjectionExtensions
{
  ...
  extension(IServiceCollection services)
  {
    ...
    /// <returns></returns>
    public IServiceCollection AddRemoteServiceWithNewClient<TRequest>(
      string baseAddress,
    ...
    /// <returns></returns>
    /// <exception cref="InvalidOperationException"></exception>
    public IServiceCollection AddRemoteServiceToExistingClient<TRequest>(
      string clientName)
      where TRequest : IServiceRequestMarker
    {
      if (!ServiceChannelRegistry.Instance.DoesClientExist(clientName))
    ...
    /// <returns></returns>
    /// <exception cref="InvalidOperationException"></exception>
    public IServiceCollection AddRemoteServicesWithNewClient(
    ...
    /// <returns></returns>
    /// <exception cref="InvalidOperationException"></exception>
    public IServiceCollection AddRemoteServicesToExistingClient(
      Assembly fromAssembly,
      string clientName,
      Func<Type, bool>? requestFilterPredicate = null)
    {
    ...
    private IServiceCollection AddRemoteServiceWithNewClientInternal(
      Type requestType,
      string clientName,
      Action<IServiceProvider, HttpClient> configureClient,
    ...
    private IServiceCollection AddRemoteServiceToExistingClientInternal(
      Type requestType,
      string clientName)
    {
      if (requestType.GetCustomAttributes<DoNotRegisterAttribute>().Any())
    ...
    private IServiceCollection AddClientInternal(
      string clientName,
      Action<IServiceProvider, HttpClient> configureClient,
      Action<IHttpClientBuilder>? configureClientBuilder)
    {
    ...
    private IServiceCollection AddRemoteServicesCore(
  )
    {
      ...
      services.AddKeyedTransient<IServiceChannelSerializer, DefaultServiceChannelSerializer>(
        ...
        (_, _) =>
        {
          return new DefaultServiceChannelSerializer(new ServiceChannelSerializerOptions()
          {
            ...
            DeserializationOptions = RemoteServiceDefinitions.DefaultJsonDeserializationOptions,
            StreamingDeserializationOptions = RemoteServiceDefinitions.DefaultJsonDeserializationOptionsForStreamingResponse
          });
        });
