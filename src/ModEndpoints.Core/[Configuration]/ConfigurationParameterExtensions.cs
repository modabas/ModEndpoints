...
{
  extension(EndpointConfigurationParameters parameters)
  {
    /// <summary>
    ...
    public TValue GetOrAddPropertyBagValue<TValue>(string key, Func<TValue> valueFactory)
    {
    ...
    public RouteGroupConfigurationParameters? GetRootRouteGroupParameters()
    {
      return parameters.ParentRouteGroupParameters?.GetRootRouteGroupParameters();
    }
  }

  extension(RouteGroupConfigurationParameters parameters)
  {
    /// <summary>
    /// Gets a value from the property bag, or adds it if it does not exist.
    /// </summary>
