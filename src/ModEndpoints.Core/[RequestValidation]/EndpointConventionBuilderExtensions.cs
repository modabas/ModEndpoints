...
public static partial class EndpointConventionBuilderExtensions
{
  ...
  {
    /// <summary>
    /// Disables request validation for all endpoints under current builder.
    /// </summary>
    ...
    /// <summary>
    /// Enables request validation for all endpoints under current builder and optionally specifies the name of the request validation service
    /// to use.
    /// </summary>
    ...
    /// <returns>The current <see cref="IEndpointConventionBuilder"/> instance for method chaining.</returns>
    public TBuilder UseRequestValidation(string? serviceName = null)
    {
